...
#Este modelo serve para de predicao com mais de um resultado
from sklearn.multiclass import OneVsRestClassifier
from sklearn.svm import LinearSVC
modeloOneVsRest = OneVsRestClassifier(LinearSVC(random_state=0))
resultadoOnvVsRest = fit_and_predict("OneVsRest", modeloOneVsRest, treino_dados, treino_marcacoes, teste_dados, teste_marcacoes)
resultados[resultadoOnvVsRest] = modeloOneVsRest
...
#print(Counter(validacao_marcacoes).values())
